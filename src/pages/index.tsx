...
export default function PostsPage() {
  ...
  const filteredPlace = places && places.filter((place: IPlace) =>
  ...
  function handleEdit(id: string) {
    const editableData: IPlace = places.find((place: IPlace) => place._id === id);
  ...
  const rows = filteredPlace && filteredPlace.map((place: IPlace) => ({
    id: place._id,
    nombre: place.nombre,
